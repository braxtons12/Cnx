...
TEST(Math, checked_add) {
	...
	TEST_ASSERT(std_option_is_none(add1));
	TEST_ASSERT(std_option_is_none(add2));
	TEST_ASSERT(std_option_is_some(add3));
	// NOLINTNEXTLINE(cppcoreguidelines-avoid-magic-numbers, readability-magic-numbers)
	TEST_ASSERT_EQUAL(std_option_unwrap(add3), 20U);
	TEST_ASSERT(std_option_is_none(add4));
	TEST_ASSERT(std_option_is_some(add5));
	// NOLINTNEXTLINE(cppcoreguidelines-avoid-magic-numbers, readability-magic-numbers)
	TEST_ASSERT_EQUAL(std_option_unwrap(add5), 10000);
	TEST_ASSERT(std_option_is_none(add6));
	TEST_ASSERT(std_option_is_some(add7));
	// NOLINTNEXTLINE(cppcoreguidelines-avoid-magic-numbers, readability-magic-numbers)
...
TEST(Math, checked_sub) {
	...
	TEST_ASSERT(std_option_is_none(sub1));
	TEST_ASSERT(std_option_is_none(sub2));
	TEST_ASSERT(std_option_is_some(sub3));
	TEST_ASSERT_EQUAL(std_option_unwrap(sub3), 0);
	TEST_ASSERT(std_option_is_none(sub4));
	TEST_ASSERT(std_option_is_some(sub5));
	// NOLINTNEXTLINE(cppcoreguidelines-avoid-magic-numbers, readability-magic-numbers)
	TEST_ASSERT_EQUAL(std_option_unwrap(sub5), -8000);
	TEST_ASSERT(std_option_is_none(sub6));
	TEST_ASSERT(std_option_is_some(sub7));
	// NOLINTNEXTLINE(cppcoreguidelines-avoid-magic-numbers, readability-magic-numbers)
...
TEST(Math, checked_mul) {
	...
	TEST_ASSERT(std_option_is_none(mul1));
	TEST_ASSERT(std_option_is_none(mul2));
	TEST_ASSERT(std_option_is_some(mul3));
	// NOLINTNEXTLINE(cppcoreguidelines-avoid-magic-numbers, readability-magic-numbers)
	TEST_ASSERT_EQUAL(std_option_unwrap(mul3), 100);
	TEST_ASSERT(std_option_is_none(mul4));
	TEST_ASSERT(std_option_is_some(mul5));
	// NOLINTNEXTLINE(cppcoreguidelines-avoid-magic-numbers, readability-magic-numbers)
	TEST_ASSERT_EQUAL(std_option_unwrap(mul5), -9000000);
	TEST_ASSERT(std_option_is_none(mul6));
	TEST_ASSERT(std_option_is_some(mul7));
	// NOLINTNEXTLINE(cppcoreguidelines-avoid-magic-numbers, readability-magic-numbers)
...
TEST(Math, checked_div) {
	...
	TEST_ASSERT(std_option_is_none(div1));
	TEST_ASSERT(std_option_is_none(div2));
	TEST_ASSERT(std_option_is_some(div3));
	// NOLINTNEXTLINE(cppcoreguidelines-avoid-magic-numbers, readability-magic-numbers)
	TEST_ASSERT_EQUAL(std_option_unwrap(div3), 10U);
	TEST_ASSERT(std_option_is_none(div4));
	TEST_ASSERT(std_option_is_some(div5));
	// NOLINTNEXTLINE(cppcoreguidelines-avoid-magic-numbers, readability-magic-numbers)
	TEST_ASSERT_EQUAL(std_option_unwrap(div5), 0);
	TEST_ASSERT(std_option_is_none(div6));
	TEST_ASSERT(std_option_is_some(div7));
	// NOLINTNEXTLINE(cppcoreguidelines-avoid-magic-numbers, readability-magic-numbers)
