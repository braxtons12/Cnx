...
i32 main(i32 argc, char** argv) {
	...
	let cstd_file = fopen("Printf.txt", "w+");

	let_mut maybe_cnx_file = cnx_file_open("Println.txt");
	...
	for(let_mut i = 0; i < num_runs; ++i) {
		...
		cnx_file_println(&cnx_file, "{}, {}, {d3}, {}", u, s, f, string);
